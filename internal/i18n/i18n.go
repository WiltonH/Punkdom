...
var catalogZH = map[string]string{
	...
	"api.books.removed":                       "项目已移入已删除",
	"api.books.restored":                      "项目已恢复",
	"api.books.purged":                        "项目已彻底删除",
...
var catalogEN = map[string]string{
	...
	"api.books.removed":                       "Project moved to Deleted.",
	"api.books.restored":                      "Project restored.",
	"api.books.purged":                        "Project permanently deleted.",
