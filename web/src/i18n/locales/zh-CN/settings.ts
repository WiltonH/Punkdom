const settings = {
  ...
  'settings.updates.dockerHint': 'Docker 版请通过镜像更新，不在容器内替换 Punkdom 程序。',
  'settings.updates.dockerInstallDisabled': '使用 Docker 更新',
  'settings.updates.dockerWatchtower': '如果 compose 中启用了 Watchtower，新镜像发布后会自动拉取并重启容器。',
