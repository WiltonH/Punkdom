const settings = {
  ...
  'settings.updates.dockerHint': 'Docker builds update through the container image instead of replacing the Punkdom binary inside the container.',
  'settings.updates.dockerInstallDisabled': 'Use Docker update',
  'settings.updates.dockerWatchtower': 'If Watchtower is enabled in compose, it will pull the new image and restart the container automatically.',
